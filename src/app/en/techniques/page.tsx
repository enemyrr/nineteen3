      ...
      <>
        <div className="tekniker">
            ...
            <div className="grid-item-techniques">
                <img src="../tekniker/Screentryck.jpg" alt="Screen Print"/>
        ...
        <div className="tekniker"> 
            ...
            <div className="grid-item-techniques">
                <img src="../tekniker/brodyr2.jpg" alt="Embroidery"/>
                <span>Embroidery</span>
            </div>
        </div>
        <div className="tekniker2"> 
            <div className="grid-item-techniques">
                    <img src="../tekniker/3D-brodyr.jpg" alt="3D Embroidery"/>
        ...
        <div className="grid-item-techniques">
                <img src="../tekniker/Sublimerat.jpg" alt="Sublimation"/>
                <span>Sublimation</span>
            </div>
            <div className="grid-item-techniques">
                    <img src="../tekniker/vavd.jpg" alt="Woven"/>
                    <span>Woven</span>
            </div>
        </div>
      </>
